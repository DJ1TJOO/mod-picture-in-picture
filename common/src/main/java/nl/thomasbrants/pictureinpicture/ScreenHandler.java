...
public class ScreenHandler {
    private static final ResourceLocation POP_OUT_ICON_TEXTURE =
        new ResourceLocation(Constants.MOD_ID, "textures/gui/pop_out.png");
    ...
    public static void afterInitScreen(MinecraftClient client, Screen screen, int windowWidth,
        ...
        if (screen instanceof TitleScreen) {
            Constants.LOG.info("Initializing {}", screen.getClass().getName());
